...
def allowed_decision():
    return {
        'allowed': True, 'confidence': 0.85, 'concerns': None,
...
def denied_decision():
    return {
        'allowed': False, 'confidence': 0.9,
        'concerns': 'kantian: Violates duty; rights_based: Violates consent',
        'stakeholders': ['user:user123', 'org:org456'],
        'frameworks': {
            'kantian': {'allowed': False, 'principle': 'Categorical Imperative', 'concerns': 'Treats as means'},
            'rights_based': {'allowed': False, 'principle': 'Human Agency', 'concerns': 'Violates autonomy'}
        }
    }
